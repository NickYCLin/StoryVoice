...
{
    /// <inheritdoc />
    public partial class AddAccountsAndBookOwnership : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_books_OwnerId_SourceProvider_ExternalSourceId",
                table: "books",
                columns: new[] { "OwnerId", "SourceProvider", "ExternalSourceId" },
                unique: true,
                filter: "\"OwnerId\" IS NOT NULL AND \"SourceProvider\" IS NOT NULL AND \"ExternalSourceId\" IS NOT NULL");
